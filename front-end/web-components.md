...
- [Declarative Shadow DOM brings Shadow DOM to the server](https://web.dev/declarative-shadow-dom/)
- [Compare coding style, bundle size and performance of 43 different ways to make a Web Component](https://webcomponents.dev/blog/all-the-ways-to-make-a-web-component/)
